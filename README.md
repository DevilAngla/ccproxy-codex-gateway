...
This repository also includes a ready-to-run Codex gateway deployment for
Windows and Docker users under
[`deployments/codex-gateway`](deployments/codex-gateway/README.md).

It packages three deployment-specific changes:

- a container-ready Codex OAuth callback that binds on `0.0.0.0`
- `/v1/responses` compatibility for plain-string `input`
- a portable Docker deployment bundle with credentials excluded from git
